...
class TestMyEpisodes(unittest.TestCase):
    ...
    def test_01_false_login(self) -> None:
    ...
    def test_03_populate_shows(self) -> None:
    ...
    def test_04_find_show_id(self) -> None:
    ...
    def test_05_add_show(self) -> None:
